...
Partial Public Class XtraBarcodePages
    ...
    Private Sub InitializeComponent()
        ...
        'Detail
        '
        Me.Detail.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrPanel1, Me.panel1})
        Me.Detail.Dpi = 254.0!
        ...
        Me.panel1.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrBarCode1, Me.XrLabel1})
        Me.panel1.Dpi = 254.0!
    ...
    "+1))+ToStr([Price]))"
        ...
        Me.CalculatedFields.AddRange(New DevExpress.XtraReports.UI.CalculatedField() {Me.MixedSecond, Me.MixedFirst})
