...
Public Class frmPassword
   Public Shared myConn As New SqlConnection(GV.myConn)
    ...
    Private Sub btOK_Click(sender As System.Object, e As System.EventArgs) Handles btOK.Click
        Dim pw As String = frmSplash.GenerateHash(tbOldPassowrd.Text)
        ...
        Using cmd = New SqlCommand(Query, myConn)
            Using dr As SqlDataReader = cmd.ExecuteReader
                If Not dr.Read() Then
                    MessageBox.Show("ﬂ·„… «·„—Ê— €Ì— ’ÕÌÕ…!", "Wrong Password", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    tbOldPassowrd.Focus()
        ...
        If tbNewPassowrd.Text <> tbRetype.Text Then
            MessageBox.Show("ﬂ·„… «·„—Ê— «·ÃœÌœ… €Ì— „ ÿ«»ﬁ…!", "Wrong Password", MessageBoxButtons.OK, MessageBoxIcon.Information)
            tbRetype.Text = ""
            tbNewPassowrd.Focus()
            tbNewPassowrd.SelectAll()
        Else
            pw = frmSplash.GenerateHash(tbNewPassowrd.Text)
